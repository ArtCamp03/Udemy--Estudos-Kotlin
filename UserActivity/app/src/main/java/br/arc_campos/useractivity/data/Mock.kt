package br.arc_campos.useractivity.data
...
class Mock {
    private val sunny = MotivationConstance.FILTER.SUNNY
    private val happy = MotivationConstance.FILTER.EMO
    private val all = MotivationConstance.FILTER.ALL

    private val langPt = MotivationConstance.LANGUAGE.PORTUGUESE
    private val langEn = MotivationConstance.LANGUAGE.ENGLISH
    private val langFr = MotivationConstance.LANGUAGE.FRENCH
